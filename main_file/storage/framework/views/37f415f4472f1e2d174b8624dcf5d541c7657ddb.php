    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create proposal')): ?>
      <div class="col-0">
        ...
        <div class="col-2 my-custom-btn">
          ...
          <div class="col-2 my-custom-btn">
              <div class="all-button-box">
                  <a href="<?php echo e(route('proposal.export')); ?>" class="btn btn-xs btn-white btn-icon-only width-auto">
                        ...
                        <table class="table table-striped mb-0 dataTable">
                            ...
                            <?php $__currentLoopData = $proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="font-style">
                                    ...
                                    <?php if(Gate::check('edit proposal') || Gate::check('delete proposal') || Gate::check('show proposal')): ?>
                                        <td class="Action">
                                            <?php $proposalID= Crypt::encrypt($proposal->id); ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('copy invoice')): ?>
                                                <a href="<?php echo e(route('proposal.link.copy',[$proposalID])); ?>" class="edit-icon bg-info copy_link" data-toggle="tooltip" data-original-title="<?php echo e(__('Click to copy')); ?>"><i class="fas fa-link"></i></a>
                                                <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\win10\Downloads\codecanyon_33263426_erpgo_saas_all_in_one_business_erp_with_project\codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm\main_file\resources\views/proposal/index.blade.php ENDPATH**/ ?>