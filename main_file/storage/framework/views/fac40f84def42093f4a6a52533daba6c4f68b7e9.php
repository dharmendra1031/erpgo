...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="w-50 float-left">
                                            <?php echo e(Form::label('signup',__('Enable SignUp'),array('class'=>'form-control-label'))); ?>

                                            <div class="">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input" name="enable_signup" id="enable_signup" <?php echo e($settings['enable_signup'] == 'on' ? 'checked="checked"' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\win10\Downloads\codecanyon_33263426_erpgo_saas_all_in_one_business_erp_with_project\codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm\main_file\resources\views/settings/index.blade.php ENDPATH**/ ?>