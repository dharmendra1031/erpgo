    ...
    <script>
        ...
        !function (e) {
            var t = {
                ...
                series: [{name: "<?php echo e(__('Expense')); ?>", data: <?php echo json_encode($chartExpenseArr); ?>}],
...
<?php $__env->startSection('action-button'); ?>
    <div class="row d-flex justify-content-end">
        ...
        <div class="col-auto my-custom">
            ...
            <a href="<?php echo e(route('report.expense.summary')); ?>" class="reset-btn" data-toggle="tooltip" data-original-title="<?php echo e(__('Reset')); ?>">
        ...
        <div class="row mt-3">
            <div class="col">
                ...
                <div class="card p-4 mb-4">
                    ...
                    <h5 class="report-text mb-0"><?php echo e(__('Expense Summary')); ?></h5>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\win10\Downloads\codecanyon_33263426_erpgo_saas_all_in_one_business_erp_with_project\codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm\main_file\resources\views/report/expense_summary.blade.php ENDPATH**/ ?>