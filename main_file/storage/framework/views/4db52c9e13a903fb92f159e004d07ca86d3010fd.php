                                            ...
                                            <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                ...
                                                                <p style=" line-height:32px"><b style="font-weight:700"><?php echo e(__('Subject : ').'New lead has been Assign to you.'); ?></b></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                                                            <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                <p style=" line-height:32px"><b style="font-weight:700"><?php echo e(__('Name : ').$lArr['lead_name']); ?></b></p>
                                                                <p style=" line-height:32px"><b style="font-weight:700"><?php echo e(__('Email : ').$lArr['lead_email']); ?></b></p>
                                                                <p style=" line-height:32px"><b style="font-weight:700"><?php echo e(__('Pipeline : ').$lArr['lead_pipeline']); ?></b></p>
                                                                <p style=" line-height:32px"><b style="font-weight:700"><?php echo e(__('Stage : ').$lArr['lead_stage']); ?></b></p>
...
<?php /**PATH C:\Users\win10\Downloads\codecanyon_33263426_erpgo_saas_all_in_one_business_erp_with_project\codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm\main_file\resources\views/email/lead_mail.blade.php ENDPATH**/ ?>