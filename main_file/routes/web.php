...
Route::get('/', ['as' => 'home','uses' =>'DashboardController@account_dashboard_index'])->middleware(['XSS']);
Route::get('/home', ['as' => 'home','uses' =>'DashboardController@account_dashboard_index'])->middleware(['auth','XSS']);
...
Route::post('user/{id}/plan/{pid}', 'UserController@activePlan')->name('plan.active')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::post('request_send/{id}', 'PlanRequestController@userRequest')->name('send.request')->middleware(['auth','XSS',]);
Route::post('request_response/{id}/{response}', 'PlanRequestController@acceptRequest')->name('response.request')->middleware(['auth','XSS',]);
Route::post('request_cancel', 'PlanRequestController@cancelRequest')->name('request.cancel')->middleware(['auth','XSS',]);
