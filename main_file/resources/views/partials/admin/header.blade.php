            ...
            <ul class="navbar-nav flex-row align-items-center">
                ...
                <li class="nav-item dropdown dropdown-animate">
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right dropdown-menu-arrow">
                        ...
                        <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('frm-logout-mobile').submit();" class="dropdown-item">
                            <i class="fas fa-sign-out-alt"></i>
                            <span>{{__('Logout')}}</span>
                        </a>
                        @if(\Auth::guard('customer')->check())
                            <form id="frm-logout-mobile" action="{{ route('customer.logout') }}" method="POST" class="d-none">
                                {{ csrf_field() }}
                            </form>
                        @else
                            <form id="frm-logout-mobile" action="{{ route('logout') }}" method="POST" class="d-none">
                                {{ csrf_field() }}
                            </form>
                        @endif
                    </div>
            ...
            <ul class="navbar-nav align-items-center d-none d-lg-flex">
                ...
                <li class="nav-item dropdown dropdown-animate">
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right dropdown-menu-arrow">
                        ...
                        @endif
                        <div class="dropdown-divider"></div>
                        <a href="{{ route('logout') }}" class="dropdown-item" onclick="event.preventDefault(); document.getElementById('frm-logout-desktop').submit();">
                            <i class="fas fa-sign-out-alt"></i>
                            <span>{{__('Logout')}}</span>
                        </a>
                        @if(\Auth::guard('customer')->check())
                            <form id="frm-logout-desktop" action="{{ route('customer.logout') }}" method="POST" class="d-none">
                                {{ csrf_field() }}
                            </form>
                        @else
                            <form id="frm-logout-desktop" action="{{ route('logout') }}" method="POST" class="d-none">
                                {{ csrf_field() }}
                            </form>
                        @endif
                    </div>
